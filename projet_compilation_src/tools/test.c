...
// une reaffectation de valeur a un booleen, global ou local, mene a une erreur syntaxique a la declaration de variable suivante, s'il y en a une (syntax error)
// une reaffectation de valeur a un entier, global ou local, mene a une erreur syntaxique a la declaration de variable suivante, s'il y en a une (syntax error)
